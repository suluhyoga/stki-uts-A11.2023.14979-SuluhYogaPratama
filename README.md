Project ini merupakan hasil **Ujian Tengah Semester (UTS)** mata kuliah **Sistem Temu Kembali Informasi (STKI)** yang dikerjakan oleh:

**👨‍🎓 Suluh Yoga Pratama - A11.2023.14979**  
Program Studi Teknik Informatika, Universitas Dian Nuswantoro (UDINUS)

Aplikasi ini mengimplementasikan dua model utama dalam **Information Retrieval System**, yaitu:
